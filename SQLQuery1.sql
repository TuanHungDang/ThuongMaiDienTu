...
GO
INSERT INTO Category (CategoryName, CategoryAlias, Description, ImageUrl) 
VALUES 
...
INSERT INTO Supplier (SupplierId, CompanyName, Logo, ContactName, Email, Phone, Address, Description) VALUES
...
INSERT INTO Brand (BrandName, SupplierId, Description) VALUES 
...
INSERT INTO Product (ProductName, ProductAlias, CategoryId, Unit, Price, Image, ProductDate, SaleOff, Viewed, Description, BrandId) VALUES 
('Redmi Note 11', 'redmi-note-11', 1, 'piece', 219.99, 'redmi_note_11.png', '2023-03-10', 0, 300, 'Xiaomi Redmi Note 11 with 6.43-inch display and Snapdragon 680.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Redmi')),
('Redmi Note 11 Pro', 'redmi-note-11-pro', 1, 'piece', 299.99, 'redmi_note_11_pro.png', '2023-04-15', 0, 320, 'Xiaomi Redmi Note 11 Pro with 6.67-inch display and Snapdragon 732G.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Redmi')),
('Redmi Note 12', 'redmi-note-12', 1, 'piece', 239.99, 'redmi_note_12.png', '2024-01-20', 0, 340, 'Xiaomi Redmi Note 12 with 6.5-inch display and MediaTek Dimensity 700.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Redmi')),
('Redmi Note 12 Pro', 'redmi-note-12-pro', 1, 'piece', 319.99, 'redmi_note_12_pro.png', '2024-02-25', 0, 360, 'Xiaomi Redmi Note 12 Pro with 6.67-inch display and MediaTek Dimensity 920.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Redmi')),
('Redmi Note 13', 'redmi-note-13', 1, 'piece', 259.99, 'redmi_note_13.png', '2024-05-05', 0, 380, 'Xiaomi Redmi Note 13 with 6.7-inch display and Snapdragon 750G.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Redmi')),
('Redmi Note 13 Pro', 'redmi-note-13-pro', 1, 'piece', 339.99, 'redmi_note_13_pro.png', '2024-06-10', 0, 400, 'Xiaomi Redmi Note 13 Pro with 6.8-inch display and Snapdragon 780G.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Redmi'));
GO
...
INSERT INTO Product (ProductName, ProductAlias, CategoryId, Unit, Price, Image, ProductDate, SaleOff, Viewed, Description, BrandId) VALUES 
('iPhone 14', 'iphone-14', 1, 'piece', 999.99, 'iphone_14.png', '2023-09-15', 0, 500, 'Apple iPhone 14 with A15 Bionic chip and advanced camera system.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'iPhone')),
('iPhone 14 Pro', 'iphone-14-pro', 1, 'piece', 1099.99, 'iphone_14_pro.png', '2023-09-20', 0, 600, 'Apple iPhone 14 Pro with ProMotion display and enhanced camera features.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'iPhone')),
('iPhone SE', 'iphone-se', 1, 'piece', 429.99, 'iphone_se.png', '2023-03-01', 0, 200, 'Apple iPhone SE, compact design with powerful performance.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'iPhone')),
('MacBook Air', 'macbook-air', 2, 'piece', 999.99, 'macbook_air.png', '2023-01-10', 0, 300, 'Apple MacBook Air with M1 chip, lightweight and powerful.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'MacBook')),
('iPad Pro', 'ipad-pro', 3, 'piece', 799.99, 'ipad_pro.png', '2023-02-15', 0, 400, 'Apple iPad Pro with M1 chip and Liquid Retina display.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'iPad'));


INSERT INTO Product (ProductName, ProductAlias, CategoryId, Unit, Price, Image, ProductDate, SaleOff, Viewed, Description, BrandId) VALUES 
('Galaxy S23', 'galaxy-s23', 1, 'piece', 799.99, 'galaxy_s23.png', '2023-02-15', 0, 400, 'Samsung Galaxy S23 with Snapdragon 8 Gen 2 and stunning display.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Galaxy')),
('Galaxy S23 Ultra', 'galaxy-s23-ultra', 1, 'piece', 1199.99, 'galaxy_s23_ultra.png', '2023-03-01', 0, 500, 'Samsung Galaxy S23 Ultra with advanced camera and S Pen.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Galaxy')),
('Galaxy A54', 'galaxy-a54', 1, 'piece', 449.99, 'galaxy_a54.png', '2023-04-10', 0, 250, 'Samsung Galaxy A54 with great performance and value.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Galaxy')),
('Galaxy Tab S8', 'galaxy-tab-s8', 3, 'piece', 699.99, 'galaxy_tab_s8.png', '2023-02-20', 0, 300, 'Samsung Galaxy Tab S8 with high-resolution display and S Pen.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Galaxy Tab')),
('Galaxy Book Pro', 'galaxy-book-pro', 2, 'piece', 1099.99, 'galaxy_book_pro.png', '2023-01-05', 0, 200, 'Samsung Galaxy Book Pro with AMOLED display and Intel processors.', (SELECT TOP 1 BrandId FROM Brand WHERE BrandName = 'Galaxy'));
